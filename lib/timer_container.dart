      ...
      children: [
        Column(
          ...
          children: [
            ...
            Text('Ngày', style: color != null ? TextStyle(color: color) : null)
          ],
        ),
        const SizedBox(width: 20),
        Column(
          ...
          children: [
            ...
            Text('Giờ', style: color != null ? TextStyle(color: color) : null)
          ],
        ),
        const SizedBox(width: 20),
        Column(
          ...
          children: [
            ...
            Text('Phút', style: color != null ? TextStyle(color: color) : null)
          ],
        ),
        const SizedBox(width: 20),
        Column(
          ...
          children: [
            ...
            Text('Giây', style: color != null ? TextStyle(color: color) : null),
          ],
        ),
      ],
    );
